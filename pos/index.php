...
<div style=""> 
	<div   id="controlpanel">
	 ...
	 include_once('./pos/menu.php');?>
	<br>
	 <?php 
	 
	  include_once('./pos/footage.php');?>
	 <hr>
		...
		$i=0; 
		  while ($typerow = $type00Result->fetchRow(DB_FETCHMODE_ASSOC))
		 {
			...
			?>
			 <td><a class="ui-button ui-widget ui-corner-all" href="/?pos=<?php echo $pos;?>&page=pos&subpage=index2.php&parent1_name=<?php echo stripslashes($typerow['typeName']);?>&parent_id=<?php echo stripslashes($typerow['id']);?>"  rel="external" ><?php echo stripslashes($typerow['typeName']);?></a></td>
			 <?php
			 if ($i==6){
				 echo "</tr>";
				 $i=0;
