 ...
 // include_once ('../include/ajax/phpAjaxTags.inc.php'); 
  ...
  $ts = new TIMESTAMP;
	...
	//get Staff name	  
	 ...
	 $sql="Select * from  invoice_amend where amend_invoice_id = ".$id;
	...
	$amend_invoice_id=$invoicerow['amend_invoice_id'];
	
	// get goods_invoice detail
	$sql="select * from goods_invoice_amend where amend_invoice_id=".$amend_invoice_id." order by id asc";
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#99CC99">
  <tr>
    ...
    <td  align="center" valign="top"><table width="100%" height="100%" border="0" cellpadding="2" cellspacing="0">
      <tr>
        <td width="13%" height="21" bgcolor="#666666"><span class="style6"><a href="/?page=invoice&subpage=invoicelist_amend.php">更改出貨單</a></span></td>
      ...
      <tr bgcolor="#FFFFFF">
        <td height="24" colspan="4"><table width="100%" border="0" cellpadding="2" cellspacing="0">
          <tr bgcolor="#3366CC">
            ...
            <td width="94" bgcolor="#006633"> <span class="style6"><?=$invoicerow['sales_name']?></span></td>
            <td width="181" bgcolor="#006633">
  ...
  <input name="delivery" type="radio" id="radio2" value="C" <?php if ($invoicerow['delivery']=="C"){echo "checked";}?>/>
          ...
          <tr bgcolor="#006633">
            ...
            <td height="24" bgcolor="#006633"><input type="text" id="warning" name="warning" readonly="readonly" /></td>
            </tr>
        </table></td>
      </tr>
      <tr bgcolor="#FFFFFF">
