...
<div > 
 ...
 <?php include_once('./posv2/footage.php');?>
	...
	<div style="position: fixed; right: 0;top :0;" id="list-items">
		<a href="/?pos=<?php echo $pos;?>&page=posv2&subpage=index3_admin.php&model1=<?php echo $model1;?>&model2=<?php echo $model2;?>&model3=<?php echo $model3;?>&parent_id=<?php echo $parent_id;?>" data-ajax="false">Admin</a>
