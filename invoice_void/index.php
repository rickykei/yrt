...
<form action="/?page=invoice&subpage=index2.php" method="POST" enctype="application/x-www-form-urlencoded" name="form1">
<table width="1000"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#99d6ff">
  <tr>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellpadding="2" cellspacing="0">
      <tr>
        <td width="14%" height="21" class=" pagetitle"><span class="style6 "><a href="../">出貨單</a>  </span></td>
        <td width="34%" class="light-pagetitle"><span class="style7"><? echo "< ".$AREA."鋪,第".$PC."機 >".$USER;?></span></td>
		  ...
		  <label><span class="style6">現金結餘 : </label></span><input name="mem_dep_bal" id="mem_dep_bal" type="text" disabled="disabled" class="blocktextbox" size="10" maxlength="10">
		   ...
		   <tr >
			...
			<select name="delivery_timeslot" id="delivery_timeslot">
			 ...
			 <td colspan="3">
				 <span class="style6">姓氏: </span><input  name="lastname" tabindex="38" type="text" id="lastname"  size="15" />
			 </td>
                  </tr>
