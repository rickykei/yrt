...
<script type="text/javascript" src="invoice_door.js"></script>
...
<form action="invoice_door_edit2.php" method="POST" enctype="application/x-www-form-urlencoded" name="form1">
...
for ($i=0;$i<$invoiceRecord;$i++)          
{
	?>
          <tr bgcolor="#CCCCCC">
			...
			<td><select name="sheet_cd[<?echo $i;?>]" id="sheet_cd[<?echo $i;?>]" onChange="count_line_total('<?=$i?>')">
			<?php
			$j=0;
			foreach ($row_prod_arr as $aa){
			?><option value="<?php echo $row_prod_arr[$j]['goods_partno'];?>" <?php if ($row_prod_arr[$j]['goods_partno']==$goods_invoice[$i]['sheet_cd']) {echo "SELECTED";}?>><?php echo $row_prod_arr[$j]['goods_partno'];?></option>
			<?php
			$j++;
			}
			?>	
            ...
            <td><select name="strip_cd[<?echo $i;?>]" id="strip_cd[<?echo $i;?>]" onChange="count_line_total('<?=$i?>')">
			<?php
			$j=0;
			foreach ($row_prod_side_arr as $aa){
			?><option value="<?php echo $row_prod_side_arr[$j]['goods_partno'];?>" <?php if ($row_prod_side_arr[$j]['goods_partno']==$goods_invoice[$i]['strip_cd']) {echo "SELECTED";}?>> <?php echo $row_prod_side_arr[$j]['goods_partno'];?></option>
			<?php
			$j++;
			}
			?>	
            ...
            <td><select id="draw_cd[<?echo $i;?>]" name="draw_cd[<?echo $i;?>]" onChange="count_line_total('<?=$i?>')"><option value="">--</option>
			<?php
			$j=0;
			foreach ($row_prod_hand_arr as $aa){
			?><option value="<?php echo $row_prod_hand_arr[$j]['goods_partno'];?>" <?php if ($row_prod_hand_arr[$j]['goods_partno']==$goods_invoice[$i]['draw_cd']) {echo "SELECTED";}?>> <?php echo $row_prod_hand_arr[$j]['goods_partno'];?></option>
			<?php
			$j++;
			}
			?>	
