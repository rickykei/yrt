...
echo "<item><name>market_price".$_GET['num']."</name>";
echo "<value>".$kph."</value></item>";
echo '<item><name>goods_detail'.$_GET['num'].'</name><value>'.$mps.'</value><item><name>stockbal</name><value>'.$inshopQty-$invoiceQty.'</value></item>';
