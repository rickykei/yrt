...
<script language="javascript">
 ...
 $(function() {
	...
	ls.remove('pos_myItems');
	ls.remove('pos_memadd');
	ls.remove('pos_memid');
 });
...
include("./include/config.php");
  ...
  $query.=" values ('$lastname',SYSDATE(),'$browseryrt','',now(),'$delivery_date',$delivery_timeslot,'$sales','$mem_name','$mem_tel','$mem_add','$mem_id','$AREA','$delivery','$man_power_price','$subdiscount','$subdeduct','$special_man_power_percent','$subsubtotal','A','$deposit','$deposit_method','$creditcardrate','$settledate','$receiver')";
...
window.location="/?page=pos&subpage=index.php"; 
</script><?
