...
?><html>
<title>invoice door form </title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<script type="text/javascript" src="./include/functions.js"></script>  
<script type="text/javascript" src="/invoice_scrap/invoice.js?20190317"></script>
...
<form name="form1" id="form1" action="/?page=invoice_scrap&subpage=index3.php" method="POST">
  ...
  <tr>
    ...
    <td width="801" align="center" valign="top"><table width="101%" height="100%" border="0" cellpadding="2" cellspacing="0">
      ...
      <tr bgcolor="#FFFFFF">
        <td colspan="4"><table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF">
          ...
          <tr bgcolor="#CCCCCC">
			...
			<td><span class="style7"><?echo round($unit_price[$i]);?></span></td>
          <td><span class="style7"><?echo round($subtotal[$i]);?></span></td>
          </tr>
		  <?
		  $total_price=$total_price+round($subtotal[$i]);
		  }
      ...
      <tr bgcolor="#FFFFFF">
		...
		$subsubtotal=round(($total_man_power_price+$total_price)*(100-$subdiscount)/100-$subdeduct);
//20060426
		if ($status=="A"|| $status=="D")
{
 echo number_format(round($subsubtotal), 2, '.', ',');
  }else{
		 echo number_format(round($deposit), 2, '.', ',');
		 }
      ...
      <tr>
		...
		<input type="hidden" name="subtotal[<?php echo $i;?>]" value="<? echo round($subtotal[$i]);?>" />
        <?php }?>
