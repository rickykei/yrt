...
<form name="hello" method="post" action="/?page=inshop&subpage=page_search_supplier.php">
...
</form><form name="hello" method="post" action="/?page=inshop&subpage=page_search_supplier.php">
