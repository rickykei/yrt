...
<div style=""> 
	...
	<hr>
		<div id="product">
		<form name="form1" action="/?page=posv2&subpage=index3_admin.php&pos=<?php echo $pos;?>" method="post" data-ajax="false" >
	...
	<a href="/?pos=<?php echo $pos;?>&page=posv2&subpage=index3.php&model1=<?php echo $model1;?>&model2=<?php echo $model2;?>&model3=<?php echo $model3;?>&parent_id=<?php echo $parent_id;?>" data-ajax="false">唯讀</a>
