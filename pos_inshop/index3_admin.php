...
<div style=""> 
	...
	<hr>
	<a href="/?pos=<?php echo $pos;?>&page=pos_inshop&subpage=index3.php&model1=<?php echo $model1;?>&model2=<?php echo $model2;?>&model3=<?php echo $model3;?>&parent_id=<?php echo $parent_id;?>" data-ajax="false">唯讀</a>
	<hr>
		<div id="page_footage">
	...
	<hr>
		<div id="product">
		<form name="form1" action="<?php echo getBaseUrl()."index3_admin.php";?> method="post" data-ajax="false" >
