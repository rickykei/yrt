<?php
 ...
 $connection = DB::connect($dsn);
  ...
  <div class="widget">
		 ...
		 <a class="ui-button ui-widget ui-corner-all" href="/?pos=<?php echo $pos;?>&page=pos_inshop&subpage=index4.php" rel="external" id="ino">出貨單</a>
		 <a class="ui-button ui-widget ui-corner-all" href="" rel="external"  id="ino_ed"></a>  
		 ...
		 { 
			 ?>
			<a class="ui-button ui-widget ui-corner-all" href="/?pos=<?php echo $pos;?>&page=pos_inshop&subpage=index2.php&parent1_name=<?php echo stripslashes($typerow['typeName']);?>&parent_id=<?php echo stripslashes($typerow['id']);?>"  rel="external" ><?php echo stripslashes($typerow['typeName']);?></a> 
			  <?php
		}?>
