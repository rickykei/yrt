...
//get name
  ...
  //insert invoice Door
  $query="update misc set daily_revenue='$daily_revenue', daily_expend='$daily_expend',daily_cheque='$daily_cheque',daily_creditcard='$daily_creditcard',daily_unionpay='$daily_unionpay',daily_eps='$daily_eps',daily_cash='$daily_cash',daily_income='$daily_income',daily_drawer='$daily_drawer',past_daily_drawer='$past_daily_drawer',drawer_diff='$drawer_diff',area='$area',invoice_date='$invoice_date',pc='$pc',modified_by='$browseryrt',modified_date=SYSDATE(),sts='A' where id='$invoice_no'";
