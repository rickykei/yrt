				 ...
				 if ($('#goods_partno'+i).val()!=""){
					...
					items.push(item);
					 ...
					 item=[];
			 		 ...
			 		 localStorage.setItem(pos+'_InvRowRec',JSON.stringify(<?php echo json_encode($invoicerow);?>));
		 			 localStorage.setItem(pos+'_invoiceno',JSON.stringify(<?php echo $id;?>));
			
				 
			 window.location.href="/?page=pos&subpage=index.php&pos="+pos;
 	};

 $(function() {

	<?php if($_REQUEST['target']!=""){ ?>
	function refresh(){
...
<form action="/?page=invoice&subpage=invoice_edit2.php" method="POST" enctype="application/x-www-form-urlencoded" name="form1">
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#99CC99">
  <tr>
	...
	<table width="100%" height="100%" border="0" cellpadding="2" cellspacing="0">
      <tr>
        <td width="13%" height="21" bgcolor="#666666"><span class="style6"><a href="/?page=invoice&subpage=invoicelist.php">更改出貨單</a><a href="javascript:backPOS('pos3');">POS</a>  </span></td>
