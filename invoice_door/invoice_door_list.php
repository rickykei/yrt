...
<body><?php
  ...
  $sql="SELECT * FROM staff where name !='' ";
	...
	$checking=0;
	  ...
	  $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_door a where a.invoice_no = '".$invoice_no."'";
	   ...
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_door a where a.member_id='".$mem_id."'";
	   ...
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_door a where a.customer_detail like '%".$customer_detail."%'";
	   ...
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_door a where a.settle like 'S' ";
	   ...
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_door a where a.invoice_date >= '".$invoice_date_start." 00:00:00' and a.invoice_date <='".$invoice_date_end." 23:59:00' ";
	   ...
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_door a where a.delivery_date >= '".$delivery_date_start." 00:00:00' and a.delivery_date <='".$delivery_date_end." 23:59:00' ";
	  		...
	  		$sql="SELECT a.created_by,a.last_update_by,call_count,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle FROM invoice_door a";
   ...
   include('./invoice_door/Pager_header.php');
...
<form name="search" action="/?page=invoice_door&subpage=invoice_door_list.php" method="POST">
...
?>   />
   ...
   <td><?=$row['sales_name']?></td>
	...
	?>
   <td><a  href="/?page=invoice_door&subpage=invoice_door_edit.php&id=<?=$row['invoice_no']?>">Edit</a></td>
   <td><a  href="/invoice_door/pdf/<?=$row['invoice_no']?>.pdf">Print</a></td></tr>
		 <? }
   ?>
