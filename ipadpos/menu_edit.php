<?php
 ...
 $connection = DB::connect($dsn);
  ...
  <div class="widget">
		 ...
		 <a class="ui-button ui-widget ui-corner-all" href="/?pos=<?php echo $pos;?>&page=ipadpos&subpage=index4_edit.php&id=<?php echo $id;?>" rel="external" id="ino">更改出貨單</a>
		 ...
		 { 
			 ?>
			<a class="ui-button ui-widget ui-corner-all" href="/?id=<?php echo $id;?>&pos=<?php echo $pos;?>&page=ipadpos&subpage=index2_edit.php&parent1_name=<?php echo stripslashes($typerow['typeName']);?>&parent_id=<?php echo stripslashes($typerow['id']);?>"  rel="external" ><?php echo stripslashes($typerow['typeName']);?></a> 
			  <?php
		}?>
