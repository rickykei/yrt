<?
  ...
  if (DB::isError($result))
	  ...
	  $sql="select ins.market_price,sum.goods_detail from sumgoods sum left join goods_instock ins on sum.goods_partno= ins.goods_partno   where sum.goods_partno='".$_GET['mph']."' and sum.status='Y'  ORDER BY ins.id DESC LIMIT 0 , 1 ";
