<LINK REL=stylesheet HREF="./include/english.css" TYPE="text/css">
<STYLE TYPE="text/css">
...
<form action="/?page=member&subpage=inmembername2.php" method="POST" enctype="application/x-www-form-urlencoded" name="membernameform">
<table width="710" height="400" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#99CC99">
  <tr>
    ...
    <td  align="center" valign="top">
      ...
      <tr>
        <td width="14%" height="21" bgcolor="#22CC22"><span class="style6"><a href="/?">會員登記表</a></span></td>
