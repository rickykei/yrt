 ...
 // include_once ('../include/ajax/phpAjaxTags.inc.php'); 
  ...
  $ts = new TIMESTAMP;
	...
	//get Staff name	  
	 ...
	 $sql="Select * from invoice_hist where invoice_hist_id = ".$id;
	...
	$sql="select * from goods_invoice_hist where invoice_hist_id=".$id." order by id asc";
      ...
      <tr bgcolor="#FFFFFF">
        <td height="24" colspan="4"><table width="100%" border="0" cellpadding="2" cellspacing="0">
          <tr bgcolor="#3366CC">
            ...
            <td width="94" bgcolor="#006633"> <select name="sales" id="sales">
			  <?php
