...
<?php
  ...
  $sql="SELECT * FROM staff where name !='' ";
	...
	$checking=0;
	  ...
	  $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_scrap a where a.invoice_no = '".$invoice_no."'";
	   ...
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_scrap a where a.member_id='".$mem_id."'";
	   ...
	   $sql ="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price, a.total_price,a.invoice_no,a.invoice_date, a.delivery_date,a.customer_name,a.member_id,a.branchID,a.delivery, a.sales_name,a.settle  from invoice_scrap a ,goods_invoice_scrap b where a.invoice_no=b.invoice_no and b.goods_partno='".$goods_partno."'";
	   ...
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_scrap a where a.customer_detail like '%".$customer_detail."%'";
	   ...
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_scrap a where a.settle like 'S' ";
	   ...
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_scrap a where a.invoice_date >= '".$invoice_date_start." 00:00:00' and a.invoice_date <='".$invoice_date_end." 23:59:00' ";
		else if ($created_by==""  && $delivery_date_start!="" && $delivery_date_end!="" && $mem_id=="" && $invoice_no=="" && $goods_partno=="" && $customer_detail =="" && $invoice_status==""  && $sales=="" )
	   $sql="SELECT a.created_by,a.last_update_by,a.call_count,a.total_price,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle  from invoice_scrap a where a.delivery_date >= '".$delivery_date_start." 00:00:00' and a.delivery_date <='".$delivery_date_end." 23:59:00' ";
	  		...
	  		$sql="SELECT a.created_by,a.last_update_by,call_count,total_price,invoice_no,invoice_date,delivery_date,customer_name,member_id,branchID,delivery, sales_name,settle FROM invoice_scrap a";
	...
	// $sql="SELECT * FROM invoice order by invoice_no desc";
			...
			//join invoice_item
			if ($goods_partno!=""){
				$sql="SELECT a.created_by,a.last_update_by,a.total_price,a.invoice_no,a.invoice_date,a.delivery_date,a.customer_name,a.member_id,a.branchID,a.delivery, a.sales_name,a.settle  from invoice_scrap as a,goods_invoice_scrap as b where a.invoice_no=b.invoice_no and b.goods_partno='".$goods_partno."' ";
				$checking=1;
			}else{
				$sql="SELECT a.created_by,a.last_update_by,a.total_price,a.invoice_no,a.invoice_date,a.delivery_date,a.customer_name,a.member_id,a.branchID,a.delivery, a.sales_name,a.settle  from invoice_scrap as a where ";
				$checking=0;
			}
   ...
   include('./invoice_scrap/Pager_header.php');
...
<form name="search" action="/?page=invoice_scrap&subpage=list.php" method="POST">
...
?>   />
   ...
   <td><?=$row['member_id']?></td>
   <td><?=$row['branchID']?></td>
   <td><?php if ($row['delivery']=="Y"){echo "送貨";} if ($row['delivery']=="C"){echo "街車";} if ($row['delivery']=="S"){echo "自取";}?></td>
   <td><?=$row['sales_name']?></td>
	...
	?>
   <td><a  href="/?page=invoice_scrap&subpage=invoice_scrap_edit.php&id=<?=$row['invoice_no']?>">Edit</a></td>
   <td><a  href="/invoice_scrap/pdf/<?=$row['invoice_no']?>.pdf">Print</a></td></tr>
		 <? }
   ?>
