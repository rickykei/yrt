...
<table width="900"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#99CC99">
  <tr>
    ...
    <table width="100%"  border="0" cellpadding="2" cellspacing="0">
      <tr>
        <td width="14%" height="21" bgcolor="#006633" class="style6"><a href="../index.php" class="style6">花紅百份比計算表</a></td>
	  ...
	  <tr>
		<td height="24" colspan="4">Shop
		<select name="shop" id="shops">
	  ...
	  <tr>
	  <td height="24" colspan="4">花紅百份比 <input name="percentage" id="percentage2" value="" type="text">% <input type="submit" name="button" id="button" value="Submit"></td></tr>
    </table>
    </td>
  </tr>
</table>
