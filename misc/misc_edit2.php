...
<form action="/?page=misc&subpage=misc_edit3.php" method="POST" enctype="application/x-www-form-urlencoded" name="form1">
      ...
      <tr bgcolor="#FFFFFF">
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#ffffff" >
		  ...
		  <tr bgcolor="#CCCCCC">
            ...
            <td ><?php echo $cheque_amt[$i];?></td>
          </tr>
		 	<?}?> 
          <tr bgcolor="#CCCCCC" >
            <td ></td>
            <td >生意總額:</span></td>
            <td ><span class=""><?php echo $daily_revenue;?></span></td>
          </tr>
		  <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >總支出:</span></td>
            <td ><span class=""><?php echo $daily_expend;?></span></td>
          </tr>
		   <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >支票: </td>
            <td > <?php echo $daily_cheque;?> </td>
          </tr>
		  <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >信用卡:</span></td>
            <td ><span class=""><?php echo $daily_creditcard;?></span></td>
          </tr>
		    <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >銀聯卡:</td>
            <td ><?php echo $daily_unionpay;?></td>
          </tr>
		      <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >AE卡:</td>
            <td ><?php echo $daily_ae_card;?></td>
          </tr>
		      <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >支付宝/微信/八逹卡:</td>
            <td ><?php echo $daily_octopus;?></td>
          </tr>
		  <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >EPS:</td>
            <td ><?php echo $daily_eps;?></td>
          </tr>
		  <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >FPS:</td>
            <td ><?php echo $daily_fps;?></td>
          </tr>
		  <tr bgcolor="#CCCCCC">
            <td ></span></td>
            <td >現金入數:</td>
            <td ><?php echo $daily_cash;?></td>
          </tr>
		  <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >入數:</td>
            <td ><span class=""><?php echo $daily_income;?></span></td>
          </tr>
		  <tr bgcolor="#CCCCCC">
		  ...
		  <tr bgcolor="#CCCCCC">
            <td ></td>
            <td >是日存柜:</td>
            <td ><?php echo $daily_drawer;?></td>
          </tr>
		  <tr bgcolor="#CCCCCC">
            <td ><span class=""></span></td>
            <td >昨日存柜:</td>
            <td ><span class=""><?php echo $past_daily_drawer;?></span></td>
          </tr>
		  <tr bgcolor="#CCCCCC">
            <td ><span class=""></span></td>
            <td>差額:</td>
            <td ><span class=""><?php echo $drawer_diff;?></span></td>
          </tr>
