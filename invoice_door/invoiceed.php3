...
//      $query="insert into invoice (invoice_no,invoice_date,sales_name,customer_name,customer_tel,customer_detail,status) values ('$invoice_no','$invoice_date','$sales_name','$customer_name','$customer_tel','$customer_detail','Y')";
      $query="update invoice set invoice_date='$invoice_date', sales_name='$sales_name', customer_name='$customer_name', customer_tel='$customer_tel', customer_detail='$customer_detail', customer_car_type='$customer_car_type',customer_car_no='$customer_car_no', member_id='' where invoice_no=$invoice_no";
...
//   if ($member_id==0) //set the member_id = NULL if = 0
 //     $member_id="NULL";
//
   //update goods_invoice database
//   $query="update goods_invoice set invoice_no='$invoice_no', goods_id=$goods_id, un=$un, ext_price=$market_price where id='$id'";
   //update invoice database
//   $query1="update invoice set invoice_no='$invoice_no', invoice_date='$invoice_date', sales_name='$sales_name', customer_name='$customer_name', customer_tel='$customer_tel', customer_detail='$customer_detail', member_id=$member_id, status='$status' where id='$iid'";

//   if (mysql_query($query) && mysql_query($query1))
///   {
///     echo "Success!<br>";
//      echo "<a href='invoiceshow.php3'>SHOW TABLE</a>";
//   }
//   else
//   {
//      echo "BAD!";
...
<!--//cos need to show invoice and regenrate so disable......
//<script language=JavaScript>
//function done() {
//alert("資料更改了!!");
//window.navigate("invoiceedit.php3?ed=<? echo $invoice_no?>");
