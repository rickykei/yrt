...
<div class="panel-container"> 
	<div id="controlpanel" class="panel-left">
	 <?php
	
	 include_once('./posv3/menu.php'); 
	  include_once('./posv3/footage.php');?>
		...
		$i=0; 
		  while ($typerow = $type00Result->fetchRow(DB_FETCHMODE_ASSOC))
		 {
			...
			?>
			 <td><a class="ui-button ui-widget ui-corner-all" href="/?pos=<?php echo $pos;?>&page=posv2&subpage=index2.php&parent1_name=<?php echo stripslashes($typerow['typeName']);?>&parent_id=<?php echo stripslashes($typerow['id']);?>"  rel="external" ><?php echo stripslashes($typerow['typeName']);?></a></td>
			 <?php
			 $i++; 
			 if ($i==5){
				 echo "</tr>";
	...
	<div   class="panel-right"   id="list-items">
