	...
	// $sql="SELECT * FROM invoice order by invoice_no desc";
			...
			if ($sales!=""){
			 ...
			 if ($total_price!="" || $total_price>0) {
				...
				if ($checking>=1) 
					$sql.=" and ";
					$sql.= " a.total_price = ".$total_price." ";
					$checking++;	
			}					
				//totalprice searching 20180210
...
<div><label class="style7">單總：</label>
<input name="total_price" type="text" class="buttonstyle"  id="total_price" size="10" maxlength="10" /></div>
...
<?php } ?>
   <hr/>
<?=$turnover?>
<table id="invoice_list" width="100%" bgcolor="#2E2E2E" border="0" cellpadding="1" cellspacing="1">
